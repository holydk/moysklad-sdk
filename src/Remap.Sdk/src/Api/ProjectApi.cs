...
namespace Confiti.MoySklad.Remap.Api
{
    ...
    public class ProjectApi : ApiAccessor
    {
        ...
        public ProjectApi(Func<MoySkladCredentials> credentialsFactory = null, Func<HttpClient> httpClientFactory = null)
            : base("/api/remap/1.2/entity/project", credentialsFactory, httpClientFactory)
        {
        }
